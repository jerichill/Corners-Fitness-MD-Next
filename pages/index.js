      ...
      <div className="home-container">
        ...
        <div className="home-hero">
          ...
          <div className="home-container01">
            <img alt="image" src="/4fcf-1500h.png" className="home-image" />
        ...
        <div className="home-section2">
          ...
          <div className="home-growing-company-section">
            ...
            <div className="home-container15">
              <h3 className="home-text25 Healine">Annual Membership</h3>
          ...
          <div className="home-container24">
            <h6 className="home-text33">
              <span>THE ENTOURAGE</span>
            </h6>
            <h3 className="home-text35 Healine">
        ...
        <div className="home-container46">
          <div>
            <div className="home-container48">
              <Script
                html={`<script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/1506040400c04d37c1c1b1954/2b55467bb24fde394b9181ad2.js");</script>`}
              ></Script>
            </div>
          </div>
        </div>
        <div className="home-section3">
          <div className="home-container49">
            <h6 className="home-text38 TextSM">
              <span>ON THE COASTLINE</span>
            </h6>
            <h3 className="home-text40 Healine">We are missing the summer</h3>
            <span className="home-text41 TextXL">
            ...
            <div className="home-services">
              ...
              <div className="home-container50">
                ...
                <h1 className="home-text43 TextXL">Grow your market</h1>
              ...
              <div className="home-container52">
                ...
                <h1 className="home-text45 TextXL">Launch time</h1>
            ...
            <div className="home-contact">
              ...
              <h2 className="home-text47">Type in the bellow form</h2>
              ...
              <div className="home-form">
                <h1 className="home-text49">Want to work with us?</h1>
                <span className="home-text50 TextXL">
                  Complete this form and we will get back to you in 24 hours.
                </span>
                <span className="home-text51 TextXS">FULL NAME</span>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="home-textinput TextSM input"
                />
                <span className="home-text52 TextXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="home-textinput1 TextSM input"
                />
                <span className="home-text53 TextXS">MESSAGE</span>
                <textarea
                  cols="80"
                  rows="4"
                  disabled="true"
      ...
      <style jsx>
        {`
          ...
          .home-hero {
            ...
            background-image: url('/4fithero-1500h.png');
          }
          .home-bg {
            flex: 0 0 auto;
            width: 100%;
          ...
          .home-container12 {
            ...
            background-image: url('/dumbbells-1400w.jpg');
